...
export default function Level() {
    ...
    return (
        <div className="text-center mb-12 px-4"> {/* Añadido px-4 para evitar que pegue a los bordes en móvil */}
    <BorderedTitle text="Nuestros niveles" bg="bg-violet-500/10" txtColor="text-indigo-500"/>
    
    {/* Contenedor Grid: Aquí controlamos el ancho máximo de la sección completa */}
    <div className="mx-auto max-w-6xl px-5 grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch pb-20 mt-4">
        ...
        >
            ...
            <div className={`p-6 text-center ${nivel.colorFondoHeader} border-b ${nivel.colorBorde}`}>
                ...
                {/* Badges / Iconos ilustrativos de la cabecera */}
            ...
            {/* Cuerpo de la tarjeta con los beneficios / checks */}
            <div className="p-6 flex-grow flex flex-col justify-between">
                <ul className="space-y-4">
                    {nivel.beneficios.map((beneficio, bIndex) => (
                    <li key={bIndex} className="flex items-start text-sm text-black text-left"> {/* Añadido text-left para que los checks alineen bien a la izquierda */}
